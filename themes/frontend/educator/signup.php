...
<main class="it-grid">
	<h2>Obrazac za oštećene</h2>
	<p>Delegati treba da popune podatke za kolege koje prijavljuju za program finansijske pomoći <strong>„Mreža solidarnosti“</strong>. Formular se popunjava <strong>po jedanput za svakog prijavljenog kolegu</strong>.</p>
	<p>Apelujemo na kolektiv da pokaže solidarnost i da se u prvoj fazi pomoći prijave oni nastavnici, učitelji i vannastavno osoblje koji su najviše pogođeni obustavom. Kako se mreža podrške bude širila, verujemo da ćemo uspeti da dopremo do što većeg broja ljudi.</p>
	...
	<p>Molimo vas da podatke unesete tačno i pažljivo, kako bismo osigurali efikasnu i pravičnu raspodelu pomoći.</p>
