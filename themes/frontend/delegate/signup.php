                ...
                <div class="it-column">
                    <div class="it-form-field">
                        ...
                        <select name="schoolName" id="school-name" class="it-school-name" aria-required="true" required>
                            ...
                            <optgroup label="Barajevo">
                                <option value="Srednja škola">Srednja škola</option>
                            </optgroup>
                            <optgroup label="Batočina">
                                <option value="Osnovna škola 'Sveti Sava'">Osnovna škola 'Sveti Sava'</option>
                            ...
                            <optgroup label="Beograd - Barajevo">
                            ...
                            <optgroup label="Beograd - Voždovac">
                            ...
                            <optgroup label="Beograd - Zvezdara">
                                <option value="Muzička škola 'Vladimir Đorđević'">Muzička škola 'Vladimir Đorđević'</option>
                            ...
                            <optgroup label="Beograd - Lazarevac">
                            ...
                            <optgroup label="Beograd - Mladenovac">
                            ...
                            <optgroup label="Beograd - Novi Beograd">
                            ...
                            <optgroup label="Beograd - Obrenovac">
                            ...
                            <optgroup label="Beograd - Palilula">
                            ...
                            <optgroup label="Beograd - Rakovica">
                            ...
                            <optgroup label="Beograd - Savski Venac">
                            ...
                            <optgroup label="Beograd - Stari Grad">
                            ...
                            <optgroup label="Beograd - Čukarica">
                            ...
                            <optgroup label="Veliko Gradište">
                            ...
                            <optgroup label="Veliko Ropotovo">
                                <option value="Medicinska škola">Medicinska škola</option>
                            </optgroup>
                            <optgroup label="Visibaba">
                                <option value="Poljoprivredna škola">Poljoprivredna škola</option>
                            </optgroup>
                            <optgroup label="Vladimirci">
                            ...
                            <optgroup label="Vrbovac">
                                <option value="Tehnička škola">Tehnička škola</option>
                            </optgroup>
                            <optgroup label="Vrnjačka Banja">
                            ...
                            <optgroup label="Doljevac">
                                <option value="Osnovna škola 'Vuk Karadžić'">Osnovna škola 'Vuk Karadžić'</option>
                            </optgroup>
                            <optgroup label="Donja Gušterica">
                                <option value="Poljoprivredna škola">Poljoprivredna škola</option>
                            </optgroup>
                            <optgroup label="Dragaš">
                                <option value="Ekonomsko-trgovinska škola">Ekonomsko-trgovinska škola</option>
                            </optgroup>
                            <optgroup label="Žabalj">
                            ...
                            <optgroup label="Zvečan">
                                <option value="Srednja škola">Srednja škola</option>
                            </optgroup>
                            <optgroup label="Zrenjanin">
                                <option value="Muzička škola 'Josif Marinković'">Muzička škola 'Josif Marinković'</option>
                            ...
                            <optgroup label="Kosovska Kamenica">
                                <option value="Gimnazija">Gimnazija</option>
                                <option value="Tehnička škola">Tehnička škola</option>
                            </optgroup>
                            <optgroup label="Kosovska Mitrovica">
                                <option value="Gimnazija">Gimnazija</option>
                                <option value="Ekonomsko-trgovinska škola">Ekonomsko-trgovinska škola</option>
                                <option value="Medicinska škola">Medicinska škola</option>
                            ...
                            <optgroup label="Kostolac">
                                <option value="Osnovna škola 'Jovan Cvijić'">Osnovna škola 'Jovan Cvijić'</option>
                                <option value="Tehnička škola Nikola Tesla">Tehnička škola Nikola Tesla</option>
                            </optgroup>
                            <optgroup label="Koceljeva">
                            ...
                            <optgroup label="Laplje Selo">
                                <option value="Gimnazija">Gimnazija</option>
                                <option value="Ekonomsko-trgovinska škola">Ekonomsko-trgovinska škola</option>
                            </optgroup>
                            <optgroup label="Lapovo">
                                <option value="Srednja škola">Srednja škola</option>
                                <option value="Osnovna škola 'Svetozar Marković'">Osnovna škola 'Svetozar Marković'</option>
                            </optgroup>
                            <optgroup label="Lebane">
                                <option value="Osnovna škola 'Vuk Karadžić'">Osnovna škola 'Vuk Karadžić'</option>
                            ...
                            <optgroup label="Leposavić">
                                <option value="Srednja škola Nikola Tesla">Srednja škola Nikola Tesla</option>
                            </optgroup>
                            <optgroup label="Leskovac">
                                <option value="Muzička škola 'Stanislav Binički'">Muzička škola 'Stanislav Binički'</option>
                            ...
                            <optgroup label="Lešak">
                                <option value="Poljoprivredna škola">Poljoprivredna škola</option>
                            </optgroup>
                            <optgroup label="Loznica">
                            ...
                            <optgroup label="Niš - Crveni Krst">
                            ...
                            <optgroup label="Petrovac na Mlavi">
                            ...
                            <optgroup label="Preoce">
                                <option value="Mašinska škola">Mašinska škola</option>
                            </optgroup>
                            <optgroup label="Preševo">
                            ...
                            <optgroup label="Smederevska Palanka">
                            ...
                            <optgroup label="Sremska Mitrovica">
                            ...
                            <optgroup label="Sremski Karlovci">
                            ...
                            <optgroup label="Srpska Crnja">
                                <option value="Srednja škola Đura Jakšić">Srednja škola Đura Jakšić</option>
                            </optgroup>
                            <optgroup label="Stanišor">
                                <option value="Muzička škola">Muzička škola</option>
                            </optgroup>
                            <optgroup label="Stara Pazova">
                            ...
                            <optgroup label="Suvo Grlo">
                                <option value="Tehnička škola">Tehnička škola</option>
                            </optgroup>
                            <optgroup label="Surdulica">
                                <option value="Osnovna škola 'Vuk Karadžić'">Osnovna škola 'Vuk Karadžić'</option>
                            ...
                            <optgroup label="Sušica">
                                <option value="Elektrotehnička škola Mihajlo Pupin">Elektrotehnička škola Mihajlo Pupin</option>
                            </optgroup>
                            <optgroup label="Temerin">
                            ...
                            <optgroup label="Futog">
                                <option value="Poljoprivredna škola">Poljoprivredna škola</option>
                            </optgroup>
                            <optgroup label="Crvenka">
                                <option value="Srednja stručna škola">Srednja stručna škola</option>
                            </optgroup>
                            <optgroup label="Crna Trava">
                            ...
                            <optgroup label="Šilovo">
                                <option value="Gimnazija">Gimnazija</option>
                            </optgroup>
                            <optgroup label="Štrpce">
                                <option value="Ekonomsko-trgovinska škola">Ekonomsko-trgovinska škola</option>
                            </optgroup>
                        </select>
                    </div>
